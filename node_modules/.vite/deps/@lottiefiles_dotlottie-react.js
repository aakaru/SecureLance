import {
  require_jsx_runtime
} from "./chunk-KHY46YTU.js";
import {
  require_react
} from "./chunk-R2SAE4SN.js";
import {
  __toESM
...
var P2 = (f, r, a) => r in f ? b4(f, r, { enumerable: true, configurable: true, writable: true, value: a }) : f[r] = a;
var W = (f, r) => {
  for (var a in r || (r = {})) O3.call(r, a) && P2(f, a, r[a]);
  if (K1) for (var a of K1(r)) R3.call(r, a) && P2(f, a, r[a]);
  return f;
};
var V = (f, r) => I4(f, P4(r));
var x3 = (f, r) => {
  var a = {};
  for (var d in f) O3.call(f, d) && r.indexOf(d) < 0 && (a[d] = f[d]);
  if (f != null && K1) for (var d of K1(f)) r.indexOf(d) < 0 && R3.call(f, d) && (a[d] = f[d]);
  return a;
};
var b = (f, r, a) => P2(f, typeof r != "symbol" ? r + "" : r, a);
...
var S4 = class {
  constructor() {
    b(this, "_lastHandleId", 0), b(this, "_lastImmediate", null);
  }
  requestAnimationFrame(f) {
...
var j4 = class {
  constructor() {
    b(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new E4() : new S4();
  }
  requestAnimationFrame(f) {
...
var k4 = (() => {
  ...
  return function(a = {}) {
    ...
    var o1 = l.wasmBinary, m1, h1 = false, c1, J, $, t1, H, K, S, O, g1;
    function M1() {
      var e = m1.buffer;
      l.HEAP8 = J = new Int8Array(e), l.HEAP16 = t1 = new Int16Array(e), l.HEAPU8 = $ = new Uint8Array(e), l.HEAPU16 = H = new Uint16Array(e), l.HEAP32 = K = new Int32Array(e), l.HEAPU32 = S = new Uint32Array(e), l.HEAPF32 = O = new Float32Array(e), l.HEAPF64 = g1 = new Float64Array(e);
    }
    var l1 = [], x1 = [], Q = [];
    function y1() {
    ...
    class D2 {
      constructor(t) {
        b(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${t})`, this.status = t;
      }
    }
    var n2 = (e) => {
    ...
    var $2 = (e) => {
      ...
      for (var o of e) {
        if (o === 0 || o === n) break;
        if (r3(o, n, i.dc + 16)) return $1(o), t;
      }
      return $1(n), t;
    }, P1 = (e, t, i) => {
      var n = $;
    ...
    }, f1 = (e, t) => Object.defineProperty(t, "name", { value: e }), a2 = [], a1 = [], M, J3 = (e) => {
      throw new M(e);
    }, w1 = (e) => {
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      if (t === void 0) throw new M("ptr should not be undefined");
      ...
      var i = v1[e];
      if (i === void 0) throw e = `${t} has unknown type ${W2(e)}`, new M(e);
      return i;
    }, U1 = () => {
    ...
    function G3(e, t, i = {}) {
      var n = t.name;
      if (!e) throw new M(`type "${n}" must have a positive integer typeid pointer`);
      if (v1.hasOwnProperty(e)) {
        if (i.Mc) return;
        throw new M(`Cannot register type '${n}' twice`);
      }
    ...
    var l2 = (e) => {
      throw new M(e.cc.fc.ec.name + " instance already deleted");
    };
    function V1() {
    }
    var d2 = (e, t, i) => {
      if (e[t].hc === void 0) {
        var n = e[t];
        e[t] = function(...o) {
          if (!e[t].hc.hasOwnProperty(o.length)) throw new M(`Function '${i}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].hc})!`);
          return e[t].hc[o.length].apply(this, o);
        }, e[t].hc = [], e[t].hc[n.pc] = n;
      }
    }, u2 = (e, t, i) => {
      if (l.hasOwnProperty(e)) {
        if (i === void 0 || l[e].hc !== void 0 && l[e].hc[i] !== void 0) throw new M(`Cannot register public name '${e}' twice`);
        if (d2(l, e, e), l[e].hc.hasOwnProperty(i)) throw new M(`Cannot register multiple overloads of a function with the same number of arguments (${i})!`);
        l[e].hc[i] = t;
      } else l[e] = t, l[e].pc = i;
    }, Y3 = (e) => {
    ...
    var f2 = (e, t, i) => {
      for (; t !== i; ) {
        if (!t.tc) throw new M(`Expected null or instance of ${i.name}, got an instance of ${t.name}`);
        e = t.tc(e), t = t.ic;
      }
      return e;
    };
    function Q3(e, t) {
      if (t === null) {
        if (this.xc) throw new M(`null is not a valid ${this.name}`);
        return 0;
      }
      if (!t.cc) throw new M(`Cannot pass "${p2(t)}" as a ${this.name}`);
      if (!t.cc.dc) throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function Z3(e, t) {
      ...
      if (!t || !t.cc) throw new M(`Cannot pass "${p2(t)}" as a ${this.name}`);
      if (!t.cc.dc) throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.vc && t.cc.fc.vc) throw new M(`Cannot convert argument of type ${t.cc.lc ? t.cc.lc.name : t.cc.fc.name} to parameter type ${this.name}`);
      if (i = f2(t.cc.dc, t.cc.fc.ec, this.ec), this.wc) {
        if (t.cc.jc === void 0) throw new M("Passing raw pointer to smart pointer is illegal");
        switch (this.Tc) {
          case 0:
            if (t.cc.lc === this) i = t.cc.jc;
            else throw new M(`Cannot convert argument of type ${t.cc.lc ? t.cc.lc.name : t.cc.fc.name} to parameter type ${this.name}`);
            break;
          case 1:
            i = t.cc.jc;
            break;
    ...
    function t0(e, t) {
      ...
      if (!t.cc) throw new M(`Cannot pass "${p2(t)}" as a ${this.name}`);
      if (!t.cc.dc) throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (t.cc.fc.vc) throw new M(`Cannot convert argument of type ${t.cc.fc.name} to parameter type ${this.name}`);
      return f2(t.cc.dc, t.cc.fc.ec, this.ec);
    }
    ...
    var B2 = (e, t, i) => {
      ...
      if (typeof i != "function") throw new M(`unknown function pointer with signature ${e}: ${t}`);
      return i;
    }, H2, T1 = (e, t) => {
      function i(s) {
...
`];
    ...
    var J1 = (e, t) => {
      ...
      if (i <<= 1, 32 < i - e && J2) return J2.decode($.subarray(e, i));
      for (i = "", n = 0; !(n >= t / 2); ++n) {
        var o = t1[e + 2 * n >> 1];
        if (o == 0) break;
    ...
    M = l.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, a1.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), l.count_emval_handles = () => a1.length / 2 - 5 - a2.length, R2 = l.PureVirtualError = O2("PureVirtualError");
    ...
    x2 = Z2, F1 = l.InternalError = class extends Error {
      ...
      if (this.cc.dc || l2(this), this.cc.sc && !this.cc.rc) throw new M("Object already scheduled for deletion");
      U1(this);
      var e = this.cc;
    ...
    } }), H2 = l.UnboundTypeError = O2("UnboundTypeError");
    var y0 = { l: (e, t, i, n) => W1(`Assertion failed: ${e ? I1($, e) : ""}, at: ` + [t ? t ? I1($, t) : "" : "unknown filename", i, n ? n ? I1($, n) : "" : "unknown function"]), Fa: (e) => {
      var t = new o2(e);
      ...
      e = R(e), t = j1(t, "wrapper"), i = w1(i);
      var n = t.ec, o = n.oc, s = n.ic.oc, h = n.ic.constructor;
      return e = f1(e, function(...c) {
        n.ic.Bc.forEach((function(u) {
          if (this[u] === s[u]) throw new R2(`Pure virtual function ${u} must be implemented in JavaScript`);
        }).bind(this)), Object.defineProperty(this, "__parent", { value: o }), this.__construct(...c);
      }), o.__construct = function(...c) {
        if (this === o) throw new M("Pass correct 'this' to __construct");
        c = h.implement(this, ...c), U1(c);
        var u = c.cc;
        if (c.notifyOnDestruction(), u.rc = true, Object.defineProperties(this, { cc: { value: u } }), L1(this), c = u.dc, c = s2(n, c), S1.hasOwnProperty(c)) throw new M(`Tried to register registered instance: ${c}`);
        S1[c] = this;
      }, o.__destruct = function() {
        if (this === o) throw new M("Pass correct 'this' to __destruct");
        U1(this);
        var c = this.cc.dc;
        if (c = s2(n, c), S1.hasOwnProperty(c)) delete S1[c];
        else throw new M(`Tried to unregister unregistered instance: ${c}`);
      ...
      e1([e], s, (h) => {
        ...
        return o.forEach((u, v) => {
          ...
          c[u.Gc] = { read: (X) => _.fromWireType(L(C, X)), write: (X, O1) => {
            var G = [];
            D(N, X, E.toWireType(G, O1)), h2(G);
          } };
      ...
      t = R(t), Z(e, { name: t, fromWireType: function(o) {
        return !!o;
      ...
      _ = R(_), s = U(o, s), c && (c = U(h, c)), v && (v = U(u, v)), C = U(L, C);
      var E = Y3(_);
      u2(E, function() {
        ...
        D = f1(_, function(...L2) {
          if (Object.getPrototypeOf(this) !== O1) throw new M("Use 'new' to construct " + _);
          if (G.qc === void 0) throw new M(_ + " has no accessible constructor");
          var F3 = G.qc[L2.length];
          if (F3 === void 0) throw new M(`Tried to invoke ctor of ${_} with invalid number of parameters (${L2.length}) - expected (${Object.keys(G.qc).toString()}) parameters instead!`);
          return F3.apply(this, L2);
        });
        var O1 = Object.create(X, { constructor: { value: D } });
        D.prototype = O1;
        var G = new K3(_, D, O1, C, N, s, c, v);
        if (G.ic) {
          var R1;
          (R1 = G.ic).uc != null || (R1.uc = []), G.ic.uc.push(G);
        }
        return N = new k1(_, G, true, false, false), R1 = new k1(_ + "*", G, false, false, false), X = new k1(_ + " const*", G, false, true, false), U2[e] = { pointerType: R1, Dc: X }, B2(E, D), [N, R1, X];
      });
    }, L: (e, t, i, n, o, s, h, c) => {
      var u = J1(i, n);
      t = R(t), t = v2(t), s = U(o, s), e1([], [e], (v) => {
        function _() {
      ...
      o = U(n, o), e1([], [e], (c) => {
        ...
        if (c.ec.qc === void 0 && (c.ec.qc = []), c.ec.qc[t - 1] !== void 0) throw new M(`Cannot register multiple constructors with identical number of parameters (${t - 1}) for class '${c.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return c.ec.qc[t - 1] = () => {
      ...
      t = R(t), o.values = {}, Z(e, { name: t, constructor: o, fromWireType: function(s) {
        return this.constructor.values[s];
      }, toWireType: (s, h) => h.value, mc: 8, readValueFromPointer: n0(t, i, n), kc: null }), u2(t, o);
    }, w: (e, t, i) => {
      var n = j1(e, "enum");
      t = R(t), e = n.constructor, n = Object.create(n.constructor.prototype, { value: { value: i }, constructor: { value: f1(`${n.name}_${t}`, function() {
      }) } }), e.values[i] = n, e[t] = n;
    }, aa: (e, t, i) => {
      t = R(t), Z(e, { name: t, fromWireType: (n) => n, toWireType: (n, o) => o, mc: 8, readValueFromPointer: r0(t, i), kc: null });
    }, M: (e, t, i, n, o, s, h) => {
      var c = J1(t, i);
      e = R(e), e = v2(e), o = U(n, o), u2(e, function() {
        T1(`Cannot call ${e} due to unbound types`, c);
      }, t - 1), e1([], c, (u) => (B2(e, q1(e, [u[0], null].concat(u.slice(1)), null, o, s, h), t - 1), []));
    }, z: (e, t, i, n, o) => {
      if (t = R(t), o === -1 && (o = 4294967295), o = (c) => c, n === 0) {
        var s = 32 - 8 * i;
        o = (c) => c << s >>> s;
      }
      ...
      i = R(i), Z(e, { name: i, fromWireType: n, mc: 8, readValueFromPointer: n }, { Mc: true });
    }, O: (e) => {
      Z(e, a0);
    }, T: (e, t, i, n, o, s, h, c, u, v, _, L) => {
      i = R(i), s = U(o, s), c = U(h, c), v = U(u, v), L = U(_, L), e1([e], [t], (C) => (C = C[0], [new k1(i, C.ec, false, false, true, C, n, s, c, v, L)]));
    }, ba: (e, t) => {
      t = R(t);
      var i = t === "std::string";
      Z(e, { name: t, fromWireType: function(n) {
        ...
        if (i) for (var h = s, c = 0; c <= o; ++c) {
          var u = s + c;
          if (c == o || $[u] == 0) {
            if (h = h ? I1($, h, u - h) : "", v === void 0) var v = h;
            else v += "\0", v += h;
            h = u + 1;
          }
        }
        else {
          for (v = Array(o), c = 0; c < o; ++c) v[c] = String.fromCharCode($[s + c]);
          v = v.join("");
        }
        return s1(n), v;
        ...
        if (!(h || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array)) throw new M("Cannot pass non-string to std::string");
        ...
        if (c = w2(4 + s + 1), u = c + 4, S[c >> 2] = s, i && h) P1(o, u, s + 1);
          ...
          if (255 < v) throw s1(u), new M("String has UTF-16 code units that do not fit in 8 bits");
          $[u + h] = v;
        }
        else for (h = 0; h < s; ++h) $[u + h] = o[h];
        return n !== null && n.push(s1, c), c;
      }, mc: 8, readValueFromPointer: D1, kc(n) {
        s1(n);
      } });
    }, S: (e, t, i) => {
      if (i = R(i), t === 2) var n = s0, o = c0, s = h0, h = (c) => H[c >> 1];
      ...
      Z(e, { name: i, fromWireType: (c) => {
        ...
        if (typeof u != "string") throw new M(`Cannot pass non-string to C++ string type ${i}`);
      ...
      H1[e] = { name: R(t), yc: U(i, n), nc: U(o, s), Ac: [] };
    }, x: (e, t, i, n, o, s, h, c, u, v) => {
      H1[e].Ac.push({ Gc: R(t), Lc: i, Jc: U(n, o), Kc: s, Rc: h, Qc: U(c, u), Sc: v });
    }, Qa: (e, t) => {
      t = R(t), Z(e, { Nc: true, name: t, mc: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, Ga: function() {
      return Date.now();
      ...
      e = X1[e], t = w1(t);
      var s = f0[i];
      return i = s === void 0 ? R(i) : s, e(t, t[i], n, o);
    }, Ja: _2, A: (e, t, i) => {
      t = _0(e, t);
      var n = t.shift();
      e--;
...
`), e = V2(c)(...u), i = `methodCaller<(${t.map((_) => _.name).join(", ")}) => ${n.name}>`, v0(f1(i, e));
      ...
      for (var o = 0, s = 0; s < i; s++) {
        ...
        t += 8;
        for (var u = 0; u < c; u++) {
          var v = e, _ = $[h + u], L = m0[v];
          _ === 0 || _ === 10 ? ((v === 1 ? Y : q)(I1(L)), L.length = 0) : L.push(_);
        }
        o += c;
      }
      return S[n >> 2] = o, 0;
    }, Ia: q0, n: j0, $: P0, La: z0, g: b0, u: F0, Na: E0, G: T0, J: R0, f: I0, _: W0, h: D0, Ma: $0, k: A0, R: O0, t: k0, V: Z0, W: Q0, Xa: w4, bb: v4, ha: o4, ka: i4, la: e4, fa: s4, db: u4, I: t4, a: L0, B: V0, E: S0, X: Y0, c: w0, Ka: U0, Ha: J0, e: C0, Y: X0, Q: K0, j: M0, y: G0, i: x0, p: B0, s: H0, Z: N0, Wa: L4, Za: g4, Ya: y4, ab: _4, $a: p4, _a: m4, cb: f4, ia: r4, ga: a4, Va: C4, fb: l4, ea: c4, gb: h4, ja: n4, Ua: M4, eb: d4, q: (e) => e, Ba: Y2, sa: (e, t) => (Q2($.subarray(e, e + t)), 0) }, w = function() {
      var e;
      function t(n) {
        var o;
        return w = n.exports, m1 = w.hb, M1(), I = w.mb, x1.unshift(w.ib), d1--, (o = l.monitorRunDependencies) == null || o.call(l, d1), d1 == 0 && b1 && (n = b1, b1 = null, n()), w;
      }
    ...
    function w4(e, t, i, n, o, s, h, c, u, v, _, L) {
      var C = g();
      try {
        return b3(e, t, i, n, o, s, h, c, u, v, _, L);
      } catch (E) {
    ...
    function M4(e, t, i, n, o, s, h, c, u, v) {
      var _ = g();
      try {
...
b(Q1, "_ModulePromise", null), b(Q1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${z3}@${W3}/dist/dotlottie-player.wasm`);
var U3 = class {
  constructor() {
    b(this, "_eventListeners", /* @__PURE__ */ new Map());
  }
...
b(i1, "_observer", null), b(i1, "_observedCanvases", /* @__PURE__ */ new Map());
var n1 = class {
  static _initializeObserver() {
    if (this._observer) return;
    let f = (r) => {
...
b(n1, "_observer", null), b(n1, "_observedCanvases", /* @__PURE__ */ new Map());
function A4(f) {
...
var M2 = (f, r) => f === "reverse" ? r.Mode.Reverse : f === "bounce" ? r.Mode.Bounce : f === "reverse-bounce" ? r.Mode.ReverseBounce : r.Mode.Forward;
var O4 = (f, r) => f === "contain" ? r.Fit.Contain : f === "cover" ? r.Fit.Cover : f === "fill" ? r.Fit.Fill : f === "fit-height" ? r.Fit.FitHeight : f === "fit-width" ? r.Fit.FitWidth : r.Fit.None;
var R4 = (f, r) => {
...
var H3 = class T {
  ...
  _render() {
    ...
    if (this._dotLottieCore.render()) {
      ...
      return typeof ImageData > "u" ? (d = this._context.createImageData(this._canvas.width, this._canvas.height), d.data.set(a)) : d = new ImageData(a, this._canvas.width, this._canvas.height), this._context.putImageData(d, 0, 0), this._eventManager.dispatch({ type: "render", currentFrame: this.currentFrame }), true;
    }
    return false;
  }
  _draw() {
    if (!(this._dotLottieCore === null || this._context === null || !this._dotLottieCore.isPlaying())) try {
      ...
      console.error("Error in animation frame:", r), this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null);
    }
  }
  play() {
  ...
  setBackgroundColor(r) {
    this._dotLottieCore !== null && (B && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = r : this._dotLottieCore.setConfig(V(W({}, this._dotLottieCore.config()), { backgroundColor: $4(r) })), this._backgroundColor = r);
  }
  setLoop(r) {
  ...
  setSegment(r, a) {
    this._dotLottieCore === null || T._wasmModule === null || this._dotLottieCore.setConfig(V(W({}, this._dotLottieCore.config()), { segment: b2([r, a], T._wasmModule) }));
  }
  setMode(r) {
    this._dotLottieCore === null || T._wasmModule === null || this._dotLottieCore.setConfig(V(W({}, this._dotLottieCore.config()), { mode: M2(r, T._wasmModule) }));
  }
  setRenderConfig(r) {
...
var z4 = class {
  constructor() {
    b(this, "_workers", /* @__PURE__ */ new Map()), b(this, "_animationWorkerMap", /* @__PURE__ */ new Map());
  }
  getWorker(f) {
...
var E2 = class _1 {
  ...
  _handleWorkerEvent(r) {
    return P(this, null, function* () {
      let a = r.data;
      a.id || (a.method === "onLoad" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event), B && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && i1.observe(this._canvas, this), this._dotLottieInstanceState.renderConfig.autoResize && n1.observe(this._canvas, this))), a.method === "onComplete" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onDestroy" && a.result.instanceId === this._id && this._eventManager.dispatch(a.result.event), a.method === "onUnfreeze" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._dotLottieInstanceState.isFrozen = false, this._eventManager.dispatch(a.result.event)), a.method === "onFrame" && a.result.instanceId === this._id && (this._dotLottieInstanceState.currentFrame = a.result.event.currentFrame, this._eventManager.dispatch(a.result.event)), a.method === "onRender" && a.result.instanceId === this._id && this._eventManager.dispatch(a.result.event), a.method === "onFreeze" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onPause" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onPlay" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onStop" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onLoadError" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onReady" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onLoop" && a.result.instanceId === this._id && (yield this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)));
    });
  }
  _create(r) {
    return P(this, null, function* () {
  ...
  _sendMessage(r, a, d) {
    return P(this, null, function* () {
      let l = { id: `dotlottie-request-${$3()}`, method: r, params: a };
...
b(E2, "_workerManager", new z4()), b(E2, "_wasmUrl", "");
var t2 = E2;
var i2 = ({ animationId: f, autoplay: r, backgroundColor: a, className: d, createDotLottie: l, data: y, dotLottieRefCallback: F, layout: j, loop: k, mode: A, playOnHover: x, renderConfig: r1, segment: Y, speed: q, src: o1, style: m1, themeData: h1, themeId: c1, useFrameInterpolation: J, workerId: $, ...t1 }) => {
  let [H, K] = (0, import_react.useState)(null), S = (0, import_react.useRef)(null), O = (0, import_react.useRef)(null), g1 = (0, import_react.useRef)(F), M1 = { speed: q, mode: A, loop: k, useFrameInterpolation: J, segment: Y, backgroundColor: a, autoplay: r, themeId: c1, workerId: $, src: o1, data: y, layout: j, renderConfig: r1 }, l1 = (0, import_react.useRef)(M1);
  g1.current = F, O.current = H, l1.current = M1, (0, import_react.useEffect)(() => {
  ...
  return (0, import_react.useEffect)(() => {
    ...
    let Q = (y1) => {
      var _a2, _b2;
      x && (y1.type === "mouseenter" && ((_a2 = O.current) == null ? void 0 : _a2.play()), y1.type === "mouseleave" && ((_b2 = O.current) == null ? void 0 : _b2.pause()));
    };
    ...
    var _a;
    (_a = O.current) == null ? void 0 : _a.setSpeed(q ?? 1);
  }, [q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setMode(A ?? "forward");
  }, [A]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setLoop(k ?? false);
  }, [k]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setUseFrameInterpolation(J ?? true);
  }, [J]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (Y == null ? void 0 : Y[0]) == "number" && typeof Y[1] == "number" && ((_a = O.current) == null ? void 0 : _a.setSegment(Y[0], Y[1]));
  }, [Y]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setBackgroundColor(a ?? "");
  }, [a]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setRenderConfig(r1 ?? {});
  }, [JSON.stringify(r1)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof y != "string" && typeof y != "object" || ((_a = O.current) == null ? void 0 : _a.load({ data: y, ...l1.current }));
  }, [y]), (0, import_react.useEffect)(() => {
    var _a;
    typeof o1 == "string" && ((_a = O.current) == null ? void 0 : _a.load({ src: o1, ...l1.current }));
  }, [o1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setMarker(t1.marker ?? "");
  }, [t1.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.loadAnimation(f ?? "");
  }, [f]), (0, import_react.useEffect)(() => {
    var _a;
    typeof c1 == "string" && ((_a = O.current) == null ? void 0 : _a.setTheme(c1));
  }, [c1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setThemeData(h1 ?? "");
  }, [h1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = O.current) == null ? void 0 : _a.setLayout(j ?? {});
